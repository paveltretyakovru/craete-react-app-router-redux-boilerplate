export var UserInfo = {
    ...
    render: function (template, userdata) {
        ...
        context.decl_operations_i  = createLambda(this.numDeclension(['покупку', 'покупки', 'покупок']));
        context.decl_transaction = createLambda(this.numDeclension(['покупка', 'покупки', 'покупок']));
        context.decl_transaction_i = createLambda(this.numDeclension(['покупку', 'покупки', 'покупок']));
